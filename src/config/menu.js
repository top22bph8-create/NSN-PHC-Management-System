...
export const MENU = [
  ...
  },
  {
    ...
    icon: ClipboardList,
    items: [
      { key: 'incoming', label: 'ทะเบียนหนังสือรับ', path: '/incoming', icon: Inbox, ready: true, module: 'incoming' },
      { key: 'outgoing', label: 'ทะเบียนหนังสือส่ง', path: '/outgoing', icon: Send, ready: true, module: 'outgoing' },
      { key: 'leave', label: 'ทะเบียนควบคุมวันลา', path: '/leave', icon: CalendarDays, ready: true, module: 'leave' },
      { key: 'vehicle', label: 'ทะเบียนควบคุมยานพาหนะ', path: '/vehicle', icon: Car, ready: true, module: 'vehicle' },
    ],
  },
  {
    ...
    icon: MapPinned,
    items: [
      { key: 'duty', label: 'แผนเวรนอกเวลาประจำเดือน', path: '/duty', icon: ClipboardList, ready: true, module: 'duty' },
      { key: 'homevisit', label: 'แผน/รายงานเยี่ยมบ้านเชิงรุกประจำเดือน', path: '/homevisit', icon: MapPinned, ready: true, module: 'homevisit' },
    ],
  },
  {
    title: 'งานบุคคล',
